...
本书来自对企业知识管理、搜索、知识图谱、RAG、智能体记忆和代码知识库资料的持续整理。正文采用就近链接，本文按主题提供进一步入口。项目版本与论文状态可能继续变化，阅读时应以链接中的官方版本为准。
...
仓库外的原始调研底稿仍保留在作者工作区，但不作为发布站点的稳定 URL；公开版本以本书正文、本文索引和仓库提交历史为准。
