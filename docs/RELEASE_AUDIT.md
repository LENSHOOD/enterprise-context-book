# v1.0.0-rc.3 发布审计（历史记录）

> 文档类别：候选版本发布门与证据状态。

审计日期：2026-08-30。这是一份 `rc.3` 的历史审计，不代表当前 `rc.9` 的状态；本表记录当时的证据，不再作为当前候选的唯一事实源。最新复核见仓库 `reviews/DEEP_REVIEW_2026-09-17.md` 与 `reviews/DEEP_REVIEW_DISPOSITION_2026-09-18.md`。
