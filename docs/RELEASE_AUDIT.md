...
审计日期：2026-08-30。这是一份 `rc.3` 的历史审计，不代表当前 `rc.9` 的状态；本表记录当时的证据，不再作为当前候选的唯一事实源。当前候选状态以 `main`、GitHub Actions、CHANGELOG 和公开的 [reviews/README.md](../reviews/README.md) 为准。
